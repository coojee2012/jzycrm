...
var CustomInfo = schema.define('CustomInfo', {
	...
	cAddr:   {type:String,limit:150},
	tel:    {type: String,limit:50},
	...
	lifeAddr:	{type:String,limit:150},
	workunit:	{type:String,limit:150},
	work:	{type:String,limit:150},
	idcard:	{type:String,limit:100},
	loverName:	{type:String,limit:50},
	userCode:	{type:String,limit:50},
	userPwd:	{type:String,limit:50},
