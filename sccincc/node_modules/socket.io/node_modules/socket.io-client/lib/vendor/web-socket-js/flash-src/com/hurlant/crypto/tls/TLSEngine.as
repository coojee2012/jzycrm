...
package com.hurlant.crypto.tls {
	...
	public class TLSEngine extends EventDispatcher {
		...
		private var handshakeHandlersServer:Object = { 0 : notifyStateError, // HANDSHAKE_HELLO_REQUEST
									...
									// Client handshake handler map					private var handshakeHandlersClient:Object = { 0 : parseHandshakeHello, // HANDSHAKE_HELLO_REQUEST
		...
		private function loadCertificates( rec:ByteArray ):void {
			...
			// Good so far
			if (certTrusted) {				// ok, that's encouraging. now for the hostname match.
