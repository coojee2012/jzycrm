...
where.callUnitID='';
var dbs=null;
res.render('OrderRecords/index.html', { title: '工单记录列表',items:dbs,serverfn:serverfn,where:where});
};
...
res.render('OrderRecords/index.html', { title: '工单记录列表',items:null,serverfn:serverfn,where:where});			
};
