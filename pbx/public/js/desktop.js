    ...
    init: function (iconData) {
                ...
                success: function (ajaxdata, textStatus) {
                    if (ajaxdata.Response == "Error") {
                        ...
                        if (_DIDSTATUS == "off") {
                            _DIDSTATUS = "on";
                            var appimg = $("#app0img");
                            $("#app0img").attr("src", "/Content/themes/default/icon/leftmenubtn1-1.png");
                        }
                        else {
                            _DIDSTATUS = "off";
                            $("#app0img").attr("src", "/Content/themes/default/icon/leftmenubtn1.png");
                        }
                        alert("操作成功");
                    }
		        ...
		        $.ajax(
            {
                ...
                success: function (ajaxdata, textStatus) {
                    if (ajaxdata.Response == "Error" && _PARKSTATUS == 0) {
                        ...
                        _PARKSTATUS = 0;
                        $("#app2img").attr("src", "/Content/themes/default/icon/leftmenubtn3.png");
                        alert("取回保持电话失败，请及时主动回呼来电！");

                    } else if (ajaxdata.Response == "Success" && _PARKSTATUS == 0) {
                        _PARKSTATUS = 1;
                        $("#app2img").attr("src", "/Content/themes/default/icon/leftmenubtn2-1.png");
                        alert("保持操作成功，45秒后将自动取回，请保持话机处于挂机状态！");
        ...
        $("#shizhong_btn").unbind('toggle')
		 .toggle(function () {
		     myLib.desktop.win.newWin({
		         WindowTitle: "工作提醒",
		         iframSrc: "/RemindReacords/MyRemindCountShow?uid=" + _USERID,
		         WindowsId: "welcome",
		         WindowAnimation: 'none',
		         WindowWidth: 800,
		         WindowHeight: 600
